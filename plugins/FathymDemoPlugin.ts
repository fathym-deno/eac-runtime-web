import { EaCRuntimePlugin } from '@fathym/eac/runtime';
import { EaCRuntimePluginConfig } from '@fathym/eac/runtime';
import { EaCProxyProcessor, EaCAIChatProcessor } from '@fathym/eac';
      ...
      EaC: {
        ...
        Applications: {
          ...
          profile: {
            Details: {
              Name: 'Profile Site',
              Description: 'The site used to for user profile display and management',
            },
            Processor: {},
          },
          publicWebBlog: {
        ...
        Modifiers: {
          ...
          'css-js-img-cache': {
            Details: {
              ...
              Description: 'Lightweight cache to use that stores data in a DenoKV database for all css, js, and images.',
          ...
          'static-cache': {
            Details: {
              Name: 'Static Cache',
              Description: 'Lightweight cache to use that stores data in a DenoKV database for static sites.',
              DenoKVDatabaseLookup: 'cache',
              CacheSeconds: 60 * 20,
              Priority: 500,
            } as EaCDenoKVCacheModifierDetails,
